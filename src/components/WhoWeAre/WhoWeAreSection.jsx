...
const WhoWeAreSection = () => (
  <section className="relative flex flex-col md:flex-row items-center justify-between px-4 md:px-16 py-16 bg-[#FAFBF5] overflow-hidden">
    ...
    {/* Images and experience badge */}
    {/* IMAGE CLUSTER — exact layout */}
    <div className="relative w-[370px] h-[360px] md:w-[420px] md:h-[400px]">
      {/* Top main image (center/back) */}
      <img
        src="/images/about-two-img-1.jpg"
        alt="Volunteers main"
        className="absolute top-0 left-64 md:left-96 -translate-x-1/2 w-[230px] h-[270px] md:w-[260px] md:h-[300px]
               rounded-2xl object-cover shadow-lg ring-1 ring-black/5 bg-neutral-200 z-10"
      />

      {/* Left image (front/overlap) */}
      <img
        src="/images/about-two-img-2.jpg"
        alt="Volunteers"
        className="absolute top-[140px] left-1 w-[150px] h-[190px] md:w-[230px] md:h-[350px]
               rounded-2xl object-cover shadow-lg ring-1 ring-black/5 bg-neutral-200 z-20"
      />
      ...
      <img
        ...
        alt="Tree planting"
        className="absolute bottom-0 top-[22rem] md:left-80 md:top-80 w-[370px] h-[150px] md:w-[200px] md:h-[160px]
               rounded-2xl object-cover shadow-lg ring-1 ring-black/5 bg-neutral-200 z-20"
      />

      {/* Experience badge (centered over the overlap) */}
      <div
        className="absolute left-64 md:left-80 -translate-x-1/2 top-[275px] md:top-[255px]
               flex items-center gap-4 rounded-2xl border-4 border-white
               bg-[#FFE08A] px-5 py-3 md:px-6 md:py-3.5 shadow-xl z-30"
      >
    ...
    <div className="md:w-1/2 mt-60 md:mt-0 pl-0 md:pl-24 pb-8 md:pb-0 z-10">
      ...
      <p className="text-gray-500 mb-6 max-w-2xl leading-relaxed">
        The implant fixture is first placed, so that it ilikely to then a dental
        prosthetic is added then dental prosthetic occaecat laborum.
      </p>
      {/* Features list */}
      ...
      <div className="flex items-center gap-8 mt-7 flex-wrap">
        ...
        <div className="flex items-center gap-2">
          ...
          <div>
            <span className="block text-gray-500 text-md">Annual Donation</span>
