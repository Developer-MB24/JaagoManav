  ...
  return (
    <section className="py-16 sm:py-20">
      <style>{`
        ...
        /* Brush/torn top mask for the image */
        .torn-mask{
      ...
      <div className="text-center mb-2">
        <span className="inline-flex items-center gap-2 rounded-full bg-emerald-50 px-3 py-1 text-sm font-semibold text-[var(--india)] ring-1 ring-emerald-100">
      ...
      {/* Heading */}
      <h2 className="text-center text-3xl sm:text-4xl md:text-5xl font-extrabold text-[var(--navy)]">
        Our Events, Let&apos;s{" "}
        <span className="inline-flex align-middle -mt-1">
          <Sprout className="mx-1 h-7 w-7 text-[var(--india)]" />
        </span>{" "}
        All Participate
      </h2>

      {/* Cards */}
      <div className="mx-auto mt-10 grid max-w-7xl grid-cols-1 gap-8 px-4 sm:px-6 md:grid-cols-2 lg:px-8">
        {events.map((e, i) => (
  ...
  return (
    <article className="rounded-2xl bg-[#FAFCF8] ring-1 ring-slate-200 shadow-soft overflow-hidden card-hover">
      ...
      <div className="px-6 sm:px-8 pt-6">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="flex items-end gap-2 leading-none">
                <span className="text-4xl font-extrabold text-[var(--india)]">
                  {date.day}
                </span>
              ...
              <p className="text-xs text-slate-500">in {date.year}</p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="text-right">
              <div className="text-base font-bold text-[var(--navy)]">
                {joined}
              </div>
        ...
        {/* Title */}
        <h3 className="mt-4 text-2xl sm:text-[28px] font-extrabold text-[var(--navy)]">
          {title}
        </h3>
        ...
        <div className="mt-5">
          <button
            onClick={onJoin}
            className="group inline-flex items-center gap-3 rounded-full bg-[#FFE08F] px-5 py-3 font-semibold text-[var(--navy)] ring-1 ring-[#F6D36A] hover:brightness-[.98]"
          >
            Join Event
            <span className="inline-flex h-9 w-9 items-center justify-center rounded-full bg-[var(--india)] text-[var(--white)] group-hover:translate-x-0.5 transition">
      ...
      <div className="mt-6 px-2 pb-2">
        <div className="rounded-xl overflow-hidden">
          ...
          {tag && (
            <div className="absolute mt-[-46px] ml-4">
              <span className="inline-flex items-center rounded-full bg-[var(--navy)] px-3 py-1 text-xs font-semibold text-white shadow-soft">
                {tag}
              </span>
            </div>
          )}
